!(function (e) {
  ...
  e(window).on("scroll", function () {
    e(this).scrollTop() > 80
      ? t.addClass("sticky_element")
      : t.removeClass("sticky_element");
  }),
    e(window)
      .resize(function () {
        e(window).width() >= 768
    ...
    e("#menu").mmenu(
      ...
      { clone: !0, classNames: { fixedElements: { fixed: "menu_fixed" } } }
    ),
    ...
    e(".products_carousel").owlCarousel({
      ...
      responsive: {
        0: { nav: !1, dots: !0, items: 2 },
        560: { nav: !1, dots: !0, items: 3 },
        768: { nav: !1, dots: !0, items: 4 },
        1024: { items: 4 },
        1200: { items: 4 },
      },
    }),
    ...
    e(".color").on("click", function () {
      e(".color").removeClass("active"), e(this).addClass("active");
    }),
    e(".numbers-row").append(
    ...
    e(".dropdown-cart, .dropdown-access").hover(
      function () {
    ...
    e(window).bind("load resize", function () {
      768 >= e(window).width()
        ? e("a.cart_bt, a.access_link").removeAttr("data-toggle", "dropdown")
        : e("a.cart_bt,a.access_link").attr("data-toggle", "dropdown");
    }),
  ...
  e(".btn_add_to_cart a").on("click", function () {
    o.addClass("show"), s.addClass("layer-is-visible");
  }),
    e("a.search_panel").on("click", function () {
      o.addClass("show"), s.addClass("layer-is-visible");
    }),
    e("a.btn_close_top_panel").on("click", function () {
      o.removeClass("show"), s.removeClass("layer-is-visible");
    });
  var a = e("footer h3");
  e(window)
    .resize(function () {
      768 >= e(window).width()
        ...
        : a.removeAttr("data-bs-toggle", "collapse");
    })
    .resize(),
    a.on("click", function () {
    ...
    e(window).width() >= 1024 &&
      e("footer.revealed").footerReveal({
        shadow: !1,
        opacity: 0.6,
        zIndex: 1,
      }),
    e(window).scroll(function () {
      e(window).scrollTop() >= 800
        ? e("#toTop").addClass("visible")
        : e("#toTop").removeClass("visible");
    }),
    ...
    setTimeout(function () {
      e(".popup_wrapper").css({ opacity: "1", visibility: "visible" }),
